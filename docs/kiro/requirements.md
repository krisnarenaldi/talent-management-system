...
- `FR-03.9` **Bulk Upload CV**: HR dapat mengunggah puluhan file CV (PDF) sekaligus langsung ke suatu posisi lamaran. Sistem akan mengirim file ke proses AI secara asinkron, yang otomatis membuatkan data kandidat tanpa mewajibkan HR menginput form manual di awal.
